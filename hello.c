...
int main(void) {
    ...
    /* Existe uma série de maneiras de um formato para que os próximos argumentos sejam substituidos do texto que o printf() vai imprimir. Para o inteiro, 
    normalmente usa o %d de decimal  */ 
    ...
    /* Nessa função printf() os %d serão substituido em ordem de como foram expostos. Por exmplo, o primeiro %d será substituido pelo o valor de ret1, o 
